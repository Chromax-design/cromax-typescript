        ...
        <main className='my-14 space-y-5 p-4 max-w-6xl lg:p-2 mx-auto'>
            ...
            <section className='grid grid-cols-12 gap-5'>
                <div className='col-span-12 md:col-span-7'>
                    <Image src={'/banner.jpg'} alt="Cromax mockup" className='object-cover w-full saturate-0 hover:scale-105 brightness-90 duration-300 ease-in-out rounded-md' width={500} height={500} quality={70} priority />
                </div>
